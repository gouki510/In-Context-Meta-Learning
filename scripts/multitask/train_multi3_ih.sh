...
# python train/train_multi3.py --ways 2 --num_class 512 --eps 0.1 --device cuda:1 --p_bursty 0 --num_task 1 --num_seq 4 --exp_name "multi3_ih_w4_c64_e0.1_p0_t1_s8" --project_name "multiple_phase_20250118_inductionhead_metrics"
python train/train_multi3.py --ways 1 --num_class 2048 --eps 0.5 --device cuda:1 --p_bursty 0 --num_task 1 --num_seq 4 --exp_name "multi3_ih_w4_c64_e0.1_p0_t1_s16" --project_name "multiple_phase_20250118_inductionhead_metrics"
# python train/train_multi3.py --ways 2 --num_class 32 --eps 0.1 --device cuda:1 --p_bursty 0 --num_task 1 --num_seq 4 --exp_name "multi3_ih_w4_c64_e0.1_p0_t1_s16" --project_name "multiple_phase_20250118_inductionhead_metrics"
# python train/train_multi3.py --ways 2 --num_class 64 --eps 0.1 --device cuda:1 --p_bursty 0 --num_task 1 --num_seq 4 --exp_name "multi3_ih_w4_c64_e0.1_p0_t1_s16" --project_name "multiple_phase_20250118_inductionhead_metrics"